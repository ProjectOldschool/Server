// Generated by delombok at Sat Feb 25 09:19:12 PST 2017
package astraeus;
...
public final class Server {
	...
	public static String getUptime() {
		...
		long seconds = (Server.getRuntime().elapsed(TimeUnit.SECONDS) >= 60 ? Server.getRuntime().elapsed(TimeUnit.SECONDS) - (minute * 60) : Server.getRuntime().elapsed(TimeUnit.SECONDS));
