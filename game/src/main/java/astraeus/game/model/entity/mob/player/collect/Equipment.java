...
public final class Equipment extends ItemContainer {
  ...
  public static final class EquipmentDefinition {
    ...
    public EquipmentDefinition(int id, String name, EquipmentType type, SkillRequirement[] requirements, boolean fullBody, boolean fullHat, boolean fullMask, int[] bonuses) {
      this.id = id;
      this.name = name;
      this.type = type;
    ...
    public boolean equals(final java.lang.Object o) {
      ...
      if (!(o instanceof Equipment.EquipmentDefinition)) return false;
      final EquipmentDefinition other = (EquipmentDefinition)o;
      ...
      if (this.isFullBody() != other.isFullBody()) return false;
      if (this.isFullHat() != other.isFullHat()) return false;
      if (this.isFullMask() != other.isFullMask()) return false;
      if (!java.util.Arrays.equals(this.getBonuses(), other.getBonuses())) return false;
      return true;
    }
    ...
    public int hashCode() {
      ...
      result = result * PRIME + (this.isFullBody() ? 79 : 97);
      result = result * PRIME + (this.isFullHat() ? 79 : 97);
      result = result * PRIME + (this.isFullMask() ? 79 : 97);
      result = result * PRIME + java.util.Arrays.hashCode(this.getBonuses());
      return result;
    }
    ...
    public java.lang.String toString() {
      return "Equipment.EquipmentDefinition(id=" + this.getId() + ", name=" + this.getName() + ", type=" + this.getType() + ", requirements=" + java.util.Arrays.deepToString(this.getRequirements()) + ", fullBody=" + this.isFullBody() + ", fullHat=" + this.isFullHat() + ", fullMask=" + this.isFullMask() + ", bonuses=" + java.util.Arrays.toString(this.getBonuses()) + ")";
    }
  }
   ...
   * Item bonus names.
   */
  public static final String[] BONUS_NAMES = { /* 0 */ "Stab",  /* 1 */ "Slash",  /* 2 */ "Crush",  /* 3 */ "Magic",  /* 4 */ "Range", 
  /* - */
  ...
  public boolean equip(int inventorySlot) {
    ...
    if (item.definition().isStackable()) {
      ...
      if (designatedSlot == Equipment.WEAPON_SLOT && twoHanded && used(Equipment.SHIELD_SLOT)) {
        if (!unequip(Equipment.SHIELD_SLOT, true)) return false;
      }
      if (designatedSlot == Equipment.SHIELD_SLOT && used(Equipment.WEAPON_SLOT)) {
        ...
        if (twoHanded) {
          if (!unequip(Equipment.WEAPON_SLOT, true)) return false;
        }
      }
      if (used(designatedSlot)) {
        Item equipItem = get(designatedSlot);
  ...
  public boolean unequip(int equipmentSlot, boolean addItem) {
    if (free(equipmentSlot)) return false;
      ...
      for (final SkillRequirement r : req.getRequirements()) {
        ...
        if (r.getSkill().getId() == Skill.PRAYER || r.getSkill().getId() == Skill.HITPOINTS) {
          if (player.getSkills().getMaxLevel(r.getSkill().getId()) < r.getLevel()) {
            player.queuePacket(new ServerMessagePacket("You need " + StringUtils.getAOrAn(r.getSkill().getName()) + " " + r.getSkill().getName() + " level of " + r.getLevel() + " to equip this item."));
            return false;
          }
        } else {
